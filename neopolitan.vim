...
let colors_name = "neopolitan"

" Set some syntax-related variables

" -> Text; Miscellaneous
hi Normal         ctermbg=none  ctermfg=none cterm=none
"below is the little tab | colour
hi SpecialKey     ctermbg=none  ctermfg=4  cterm=none
...
" -> Line info  
hi LineNr         ctermbg=0  ctermfg=43  cterm=none
hi StatusLine     ctermbg=0  ctermfg=43  cterm=none
hi StatusLineNC   ctermbg=0  ctermfg=15  cterm=none

" -> Messages
hi ErrorMsg       ctermbg=none  ctermfg=48 cterm=none
...
hi ModeMsg        ctermbg=none  ctermfg=71 cterm=none
...
hi DiffText       ctermbg=none  ctermfg=10 cterm=underline
...
" -> Visual Mode
hi Visual         ctermbg=8    ctermfg=71 cterm=none
hi VisualNOS      ctermbg=none ctermfg=7  cterm=none

" -> Code
hi Comment        ctermbg=none  ctermfg=39  cterm=none
hi Constant       ctermbg=none  ctermfg=10 cterm=none
hi String         ctermbg=none  ctermfg=70  cterm=none
hi Error          ctermbg=none  ctermfg=4  cterm=none
hi Identifier     ctermbg=none  ctermfg=35 cterm=none
hi Function       ctermbg=none  ctermfg=76 cterm=none
hi Ignore         ctermbg=none  ctermfg=8  cterm=none
hi MatchParen     ctermbg=none  ctermfg=8  cterm=none
hi PreProc        ctermbg=none  ctermfg=39  cterm=none
...
hi Statement      ctermbg=none  ctermfg=71 cterm=none
hi Operator       ctermbg=none  ctermfg=35  cterm=none
hi Delimiter      ctermbg=none  ctermfg=4 cterm=none
hi Type           ctermbg=none  ctermfg=43 cterm=none
hi Exception      ctermbg=none  ctermfg=12 cterm=none

  " -> HTML-specific (projektile's)
